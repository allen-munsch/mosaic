defmodule Mosaic.AST.Ingestor do
  ...
  @spec ingest_file(String.t(), keyword()) :: {:ok, map()} | {:error, term()}
  ...
  @spec ingest_directory(String.t(), keyword()) :: {:ok, map()} | {:error, term()}
  ...
  @spec ingest_repository(String.t(), keyword()) :: {:ok, map()} | {:error, term()}
  def ingest_repository(repo_path, opts \\ []) when is_binary(repo_path) do
